...
<template>
  ...
  <fwb-sidebar class="w-1/6 shadow-xl">
    ...
    <fwb-sidebar-item>
      ...
      <template #default>Inicio</template>
    </fwb-sidebar-item>
    <fwb-sidebar-item>
      <template #icon>
        <svg
      ...
      <template #default>
        <router-link to="/grados" class="">Grados</router-link>
      </template>
      <!--      <template #suffix>-->
    ...
    <fwb-sidebar-item>
      ...
      <template #default>Asignaturas</template>
      <template #suffix>
        <span
            class="inline-flex items-center justify-center w-auto h-3 p-3 ml-3 text-xs font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">mantenimiento</span>
      </template>
    </fwb-sidebar-item>
    <fwb-sidebar-item>
      <template #icon>
    ...
    <fwb-sidebar-item>
      ...
      <template #default>Profesores</template>
      <template #suffix>
        <span
            class="inline-flex items-center justify-center w-auto h-3 p-3 ml-3 text-xs font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">mantenimiento</span>
      </template>
    ...
    <fwb-sidebar-item>
      ...
      <template #default>Alumnos</template>
    </fwb-sidebar-item>
    <fwb-sidebar-item>
      <div class="flex space-x-3" >
        <svg
            class="flex-shrink-0 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 -960 960 960" fill="currentColor">
          <path
